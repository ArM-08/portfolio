...
const CardProjContainer = styled.div`
border-radius: 8px;
height: 300px;
...
<Button className="verMais" onClick={()=> setModal(!open)}>Saiba Mais</Button>
</CardProjContainer>
{open && ( <ModalProject open={open} closed={()=> setModal(!open)}></ModalProject>) }
